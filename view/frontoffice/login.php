    ...
    <div class="auth-right">
      <div class="auth-form-card">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px">
          <button class="btn btn-outline" onclick="toast('Connexion Google bientôt disponible','info')">
          ...
          <button class="btn btn-outline face-login-btn" onclick="openFaceLoginModal()" title="Se connecter par reconnaissance faciale">
