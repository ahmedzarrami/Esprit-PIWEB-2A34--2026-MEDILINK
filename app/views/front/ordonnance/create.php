            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="date" id="date_ordonnance" name="date_ordonnance"
                           value="<?= htmlspecialchars($old['date_ordonnance'] ?? date('Y-m-d')) ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="ligne-card" data-index="<?= $idx ?>">
                    <div class="ligne-card-header">
                        <div class="ligne-med-badge">
                            ...
                            <span class="ligne-med-nom"><?= htmlspecialchars($selectedNom) ?><?= $selectedDosage ? ' <small>(' . htmlspecialchars($selectedDosage) . ')</small>' : '' ?></span>
                        </div>
