...
class Rendezvous {
    ...
    public function __construct(?int $id = null, ?int $medecin_id = null, ?int $patient_id = null, ?string $date_rdv = null, ?string $heure_rdv = null, ?string $statut = 'confirmé') {
        $this->id = $id;
    ...
    public function setPatientId(int $patient_id): self { $this->patient_id = $patient_id; return $this; }
