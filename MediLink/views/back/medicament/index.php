...
<section class="stats-grid">
    ...
    <article class="stat-card warning">
        <span>Formes disponibles</span>
        <strong><?= e((string) $stats['formes']) ?></strong>
    </article>
    <article class="stat-card danger">
        <span>Fabricants</span>
        <strong><?= e((string) $stats['fabricants']) ?></strong>
    </article>
...
<section class="panel">
    ...
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                <?php if ($medicaments === []): ?>
                    <tr><td colspan="8" class="empty-state">Aucun médicament trouvé.</td></tr>
                <?php else: ?>
