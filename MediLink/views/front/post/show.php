...
<!-- Assistant Médical Flottant -->
<div class="medical-assistant-trigger" id="assistant-trigger" title="Assistant Médical">
    <i class="fas fa-robot"></i>
</div>

<div class="assistant-window" id="assistant-window">
    <div class="assistant-header">
        <span><i class="fas fa-user-md"></i> Assistant MediLink</span>
        <i class="fas fa-times" id="close-assistant" style="cursor: pointer;"></i>
    </div>
    <div class="assistant-content" id="assistant-chat-content">
        <div class="assistant-msg ai">
            Bonjour ! Je suis votre assistant médical intelligent. Je peux analyser cette discussion ou répondre à toutes vos questions médicales. 
            <br><br>
            <strong>Comment puis-je vous aider aujourd'hui ?</strong>
        </div>
    </div>
    <div class="assistant-footer">
        <input type="text" id="assistant-input" class="assistant-input" placeholder="Posez une question médicale...">
        <button id="send-assistant-msg" class="btn-send" title="Envoyer">
            <i class="fas fa-paper-plane"></i>
        </button>
    </div>
    <div style="padding: 0.5rem 1rem 1rem; background: #fff;">
        <button id="run-assistant-analysis" class="btn btn-secondary" style="width: 100%; font-size: 0.75rem; border-radius: 100px; padding: 0.5rem;">
            <i class="fas fa-magic"></i> Résumer la discussion
        </button>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const runAnalysisBtn = document.getElementById('run-assistant-analysis');
    const chatContent = document.getElementById('assistant-chat-content');
    const sendBtn = document.getElementById('send-assistant-msg');
    ...
    function appendMessage(text, role = 'ai') {
        ...
        // Simple markdown-like formatting for AI responses (newlines and bold)
    ...
    function showTyping() {
        ...
        typingDiv.className = 'assistant-msg ai';
