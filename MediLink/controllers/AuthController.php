...
class AuthController
{
    ...
    {
        // Effacer explicitement toutes les variables de session (auth unifiée + modules RDV)
        $_SESSION = [];

        // Invalider le cookie de session côté navigateur
        ...
        session_destroy();
        header('Location: /medilink_medicament/MediLink/index.php?page=home');
        exit;
    }
}
