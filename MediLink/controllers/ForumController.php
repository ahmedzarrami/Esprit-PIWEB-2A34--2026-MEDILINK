...
class ForumController {
    ...
    public function list(): void {
        ...
        require __DIR__ . '/../views/front/forum/list.php';
    }
    ...
    public function show($id): void {
        ...
        require __DIR__ . '/../views/front/forum/show.php';
    }
    ...
    public function adminList(): void {
        ...
        require __DIR__ . '/../views/back/forum/list.php';
    }
    ...
    public function create(): void {
        ...
        require __DIR__ . '/../views/back/forum/create.php';
    }
    ...
    public function edit($id): void {
        ...
        require __DIR__ . '/../views/back/forum/edit.php';
    }
