...
class FrontOrdonnanceController extends FrontController
{
    private PDO $db;
    ...
    public function store(): void
    {
        ...
        $ordonnance->setNumero('ORD-' . strtoupper(uniqid()));
    ...
    public function update(): void
    {
        ...
        $this->db->prepare(
            'UPDATE ordonnances
             SET patient_nom=:patient_nom, patient_age=:patient_age,
    ...
    private function rowToArray(array $row): array
    {
        ...
        $o->setPatientAge(isset($row['patient_age']) && $row['patient_age'] !== null ? (int) $row['patient_age'] : null);
